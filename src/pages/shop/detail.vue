    ...
    <Form ref="data" :model="data" :rules="ruleValidate" :label-width="110">
      <Row>
        ...
        <Row style="margin-bottom: 24px;">
          <Col span="24">
          <span style="font-size: 16px; color: #657180;">基本信息</span></Col>
        </Row>
        ...
        <Row style="margin-bottom: 24px;">
          <Col span="24">
          <span style="font-size: 16px; color: #657180;">财务信息</span></Col>
        </Row>
        ...
        <Row style="margin-bottom: 24px;">
          <Col span="24">
          <span style="font-size: 16px; color: #657180;">认证信息</span></Col>
        </Row>
