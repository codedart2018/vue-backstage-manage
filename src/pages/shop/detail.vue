      ...
      <Form ref="shopData" :model="shopData" :rules="ruleValidate" :label-width="88" class="shop-form">
        <Row>
          <i-col span="8">
            ...
            <Row style="padding-bottom: 10px; margin-bottom: 10px; border-bottom: 1px dashed #dedede">
              <i-col span="24">
                <span class="card-form-title">联系信息</span></i-col>
            </Row>
            ...
            <Form-item label="商铺备注：" prop="remarks">
              <Input v-model="shopData.remarks" type="textarea" :rows="4" placeholder="商铺200字简要说明(后台备注,前台无法浏览)..."></Input>
            </Form-item>
          </i-col>
          <i-col span="1">&nbsp;</i-col>
          <i-col span="8">
          ...
          <i-col span="6">
            ...
            <Row style="margin-bottom: 15px;">
              ...
              <i-col span="6" class-name="padding-left-15">
                <infoCard
                  id-name="visit_count"
                  :end-val="count.visit"
                  color="#64d572"
            ...
            <Row style="padding-bottom: 10px; margin-bottom: 10px; border-bottom: 1px dashed #dedede">
              <i-col span="24">
                <span class="card-form-title">快捷面板</span></i-col>
            </Row>
            <Row type="flex" justify="space-between">
              <i-col span="8" class="col-plan">
                <div class="box">
                  <div class="item">
              ...
              <i-col span="8" class="col-plan padding-left-15">
                <div class="box">
                  <div class="item">
